...
public class gmailTest {
	...
	//Step1:
 	@Test()
	public void Step1_LoginToConsole() throws Exception 
	{

		An_email_alert_should_be_sent("silverbackuser@gmail.com", "S1lverb@ck", "edfderw", "1234", "admin");
		
	}
 	
	public void An_email_alert_should_be_sent(String email, String Passwd, String Username, String Pswd, String Createdby  ) {
	...
	try
		...
		for (Message mail : messages) {
			...
			if ((mail.getSubject().equalsIgnoreCase("A Silverback user account has been created for you."))
				...
				System.out.println(" Mail from search : ---" + "Subject : " +  mail.getSubject() + "mail " + mail.getSentDate() + "content" + readMailContent(mail, Username, Pswd, Createdby));
				break;
	...
	private boolean readMailContent(Message msg, String searchUser, String searchPass, String createdBy) {
		boolean found = false;
