...
import com.google.common.collect.Table.Cell;
	...
	//Method to read from Excel
		...
		public static void appendXl(String readFileName, String iSheet, String[][] xData) throws Exception{
			
			File myxl = new File(readFileName); 		
			FileInputStream myStream = new FileInputStream(myxl); //  FIle input stream reads i/p and o/p into the file path we created above. 		
			HSSFWorkbook myWB = new HSSFWorkbook(myStream); // Creates workbook within this file.			
			HSSFSheet osheet = myWB.getSheet(iSheet);
		    ...
		    FileOutputStream fileOut = new FileOutputStream(readFileName);
		    myWB.write(fileOut);
		    fileOut.close();
		    fileOut.close();
		}
